...
namespace IPCS.Repositories.Migrations
{
    ...
    [Migration("20170829041118_RefactorProjectActivity")]
    partial class RefactorProjectActivity
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("IPCS.Entities.ProjectActivity", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("ProjectActivity");
                });
            ...
            modelBuilder.Entity("IPCS.Entities.ProjectCriticalPath", b =>
                {
                    b.HasBaseType("IPCS.Entities.ProjectActivity");
                    ...
                    b.HasDiscriminator().HasValue("ProjectCriticalPath");
                });
            ...
            modelBuilder.Entity("IPCS.Entities.ProjectSafety", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ProjectSafety");
                });
            ...
            modelBuilder.Entity("IPCS.Entities.ProjectWeather", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ProjectWeather");
                });
